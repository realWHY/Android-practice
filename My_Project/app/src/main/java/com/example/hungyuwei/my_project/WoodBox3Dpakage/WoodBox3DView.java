...
import com.example.hungyuwei.my_project.R;
...
class WoodBox3DView extends GLSurfaceView {
	...
	public WoodBox3DView(Context context) {
        super(context);
	...
	public void initFog(GL10 gl)
	{
		...
		gl.glFogf(GL10.GL_FOG_DENSITY, 0.09f);//�]�w�����@��
