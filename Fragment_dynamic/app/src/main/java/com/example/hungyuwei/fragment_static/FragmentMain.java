            ...
            private View.OnClickListener btnShowResult1OnClick =
                    new View.OnClickListener(){
                        ...
                        public void onClick(View view) {
                            ...
                            fragTran.replace(R.id.frameLay,fragmentResult,TAG_FRAGMENT_RESULT_1);
                            fragTran.commit();
                            mShowResult = true;
                        }
                    };
    ...
    private View.OnClickListener btnShowResult2OnClick =
            new View.OnClickListener(){
                ...
                public void onClick(View view) {
                    ...
                    FragmentTransaction fragTran =
                            getFragmentManager().beginTransaction();
                    fragTran.replace(R.id.frameLay,fragmentResult2,TAG_FRAGMENT_RESULT_2);
                    fragTran.commit();
                    mShowResult = true;
                }
            };
    ...
    private View.OnClickListener btnHideResultOnclick =
            new View.OnClickListener(){
                ...
                public void onClick(View view) {
                    ...
                    FragmentResult fragmentResult1 =
                            (FragmentResult)fragMgr.findFragmentByTag(TAG_FRAGMENT_RESULT_1);
                    if(fragmentResult1 != null){
                        FragmentTransaction fragTrans =
                                fragMgr.beginTransaction();
                        fragTrans.remove(fragmentResult1);
                        fragTrans.commit();
                        return;
                    }

                    FragmentResult_2 fragmentResult_2=
                            (FragmentResult_2)fragMgr.findFragmentByTag(TAG_FRAGMENT_RESULT_2);
                    if(fragmentResult_2 != null){
                        FragmentTransaction fragTrans2 =
                                fragMgr.beginTransaction();
                        fragTrans2.remove(fragmentResult_2);
                        return;
                    }
                }
            };
